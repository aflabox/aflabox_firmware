...
class LCD_2inch4(lcdconfig.RaspberryPi):
    # Modified dimensions for landscape
    ...
    def Init(self):
        ...
        time.sleep(0.12)    # Added delay after sleep out
        ...
        self.data(0x78)       # Modified for landscape orientation
